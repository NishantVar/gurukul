...
**The decision rule: if you're going to interact with a service more than a couple of times, check if an MCP server exists.** If yes, connect it. If no, browser automation or manual workarounds are fine until one appears.
